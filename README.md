...
После нажатия кнопки следующее текстовое сообщение пользователя считается флагом выбранной задачи.
...
Администраторы полностью исключаются из рейтинга. Страница содержит до 10 участников и переключается inline-кнопками.
...
1. Добавить в конфиг возможность смены временной зоны
2. Переделать пункты меню
3. Добавить часовой пояс в конфигурацию бота
